...
def serializedATN():
    return [
        ...
        1,0,32,33,338,0,65,1,0,0,0,2,71,1,0,0,0,4,80,1,0,0,0,6,99,1,0,0,
        ...
        1,70,1,1,0,0,0,71,72,3,38,19,0,72,73,5,36,0,0,73,75,5,1,0,0,74,76,
        ...
        0,99,98,1,0,0,0,100,7,1,0,0,0,101,102,3,38,19,0,102,105,5,36,0,0,
        ...
        0,147,13,1,0,0,0,148,149,3,38,19,0,149,150,5,36,0,0,150,151,5,5,
        ...
        1,0,0,0,206,207,5,36,0,0,207,209,5,1,0,0,208,210,3,28,14,0,209,208,
        ...
        0,0,0,238,239,3,38,19,0,239,240,5,36,0,0,240,37,1,0,0,0,241,242,
        ...
        0,0,258,45,1,0,0,0,259,270,5,36,0,0,260,270,5,37,0,0,261,270,5,38,
        0,0,262,270,5,39,0,0,263,270,5,40,0,0,264,270,3,26,13,0,265,266,
...
class CASSParser ( Parser ):
    ...
    def prog(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & 2130304037762) != 0)):
                    break
    ...
    def compoundStatement(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 2130304037762) != 0):
                self.state = 81
                self.statement()
                self.state = 86
                self._errHandler.sync(self)
