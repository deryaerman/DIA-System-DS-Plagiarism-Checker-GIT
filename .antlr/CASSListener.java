...
public interface CASSListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CASSParser#forInit}.
	 * @param ctx the parse tree
	 */
	void enterForInit(CASSParser.ForInitContext ctx);
	/**
	 * Exit a parse tree produced by {@link CASSParser#forInit}.
	 * @param ctx the parse tree
	 */
	void exitForInit(CASSParser.ForInitContext ctx);
	/**
	 * Enter a parse tree produced by {@link CASSParser#forUpdate}.
	 * @param ctx the parse tree
	 */
	void enterForUpdate(CASSParser.ForUpdateContext ctx);
	/**
	 * Exit a parse tree produced by {@link CASSParser#forUpdate}.
	 * @param ctx the parse tree
	 */
	void exitForUpdate(CASSParser.ForUpdateContext ctx);
	/**
